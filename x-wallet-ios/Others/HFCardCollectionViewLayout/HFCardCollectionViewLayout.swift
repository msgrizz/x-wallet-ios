...
open class HFCardCollectionViewLayout: UICollectionViewLayout, UIGestureRecognizerDelegate {
    ...
    ///
    /// Default: 80
    @IBInspectable open var cardHeadHeight: CGFloat = 64 {
        didSet {
    ...
    ///
    /// Default: 5
    @IBInspectable open var bottomNumberOfStackedCards: Int = 0 {
        didSet {
    ...
    ///
    /// Default: 0
    @IBInspectable open var spaceAtTopForBackgroundView: CGFloat = 10 {
        didSet {
