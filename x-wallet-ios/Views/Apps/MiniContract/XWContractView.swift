...
class XWContractView: UIView {
    ...
    func getCardRect(index: Int) -> CGRect {
        switch index {
        case 0:
            return CGRect(x: 7, y: 7, width: UIScreen.main.bounds.size.width - 54, height: 82)
        case 1:
            return CGRect(x: 7, y: Int(7 + insert * 2), width: Int(UIScreen.main.bounds.size.width - 54), height: 82)
        case 2:
            return CGRect(x: 7, y: Int(7 + insert * 4), width: Int(UIScreen.main.bounds.size.width - 54), height: 82)
        default:
            return CGRect(x: 7, y: 7, width: UIScreen.main.bounds.size.width - 54, height: 70)
        }
    }
