//
//  XWChangePasswordViewController.swift
//  x-wallet-ios
//
...
class XWChangePasswordViewController: UIBaseViewController {
    ...
    override func viewDidLoad() {
        ...
        self.navigationItem.title = NSLocalizedString("Password Settings", comment: "")
