...
open class ResourceSMiniContract: Codable {
    ...
    public init(abolished: Bool?, activated: Bool?, audioUrl: String?, complete: Bool?, confirmed: Bool?, content: String?, createTime: Int64?, id: Int64?, important: Bool?, lastModifyTime: Int64?, links: [Link]?, miniContractType: MiniContractType?, photoUrl: String?, receiver: SAccount?, sender: SAccount?, title: String?, version: Int64?, videoUrl: String?) {
