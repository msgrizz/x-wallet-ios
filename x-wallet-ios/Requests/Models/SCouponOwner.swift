...
open class SCouponOwner: Codable {
    ...
    public init(activated: Bool?, createTime: Int64?, id: Int64?, important: Bool?, lastModifyTime: Int64?, owner: SAccount?, scoupon: SCoupon?, used: Bool?, version: Int64?) {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(scoupon, forKey: "scoupon")
    ...
    public required init(from decoder: Decoder) throws {
        ...
        scoupon = try container.decodeIfPresent(SCoupon.self, forKey: "scoupon")
