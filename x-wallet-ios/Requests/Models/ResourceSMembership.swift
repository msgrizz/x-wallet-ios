...
open class ResourceSMembership: Codable {
    ...
    public init(activated: Bool?, createTime: Int64?, creator: SAccount?, expireAt: Int64?, id: Int64?, issued: Bool?, issuedNum: Int64?, lastModifyTime: Int64?, links: [Link]?, logo: String?, membershipType: MembershipType?, name: String?, remarks: String?, version: Int64?) {
