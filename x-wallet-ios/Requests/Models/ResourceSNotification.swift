...
open class ResourceSNotification: Codable {
    ...
    public init(action: String?, activated: Bool?, createTime: Int64?, data: String?, id: Int64?, lastModifyTime: Int64?, links: [Link]?, receiver: SAccount?, sender: SAccount?, title: String?, version: Int64?) {
        self.action = action
