...
open class ResourceSAccount: Codable {
    ...
    public init(about: String?, activated: Bool?, createTime: Int64?, email: String?, id: Int64?, lastModifyTime: Int64?, links: [Link]?, loginName: String?, loginPass: String?, mobile: String?, nickname: String?, paymentPass: String?, version: Int64?) {
        self.about = about
